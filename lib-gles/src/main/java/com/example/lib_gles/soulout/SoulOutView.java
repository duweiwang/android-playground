 ...
 * 可以直接添加到布局中使用，展示纹理渐变透明效果
 */
public class SoulOutView extends GLSurfaceView {

    private SoulOutRenderer mRenderer;
    ...
    public SoulOutView(Context context, AttributeSet attrs) {
        ...
        mRenderer = new SoulOutRenderer(context);
    ...
    private static class SoulOutRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            android.util.Log.d("SoulOutView", "onSurfaceCreated");
            
            // 加载着色器程序
            String vertexShader = loadShaderFromAssets("soulout_v.glsl");
            String fragmentShader = loadShaderFromAssets("soulout_f.glsl");
            ...
            android.util.Log.d("SoulOutView", "Position handle: " + mPositionHandle + ", TexCoord handle: " + mTextureCoordHandle);
            ...
            android.util.Log.d("SoulOutView", "MVP handle: " + mMvpMatrixHandle + ", Texture handle: " + mTextureHandle + ", Alpha handle: " + mAlphaHandle);
            ...
            if (mImageResId != 0 && mBitmap != null) {
                android.util.Log.d("SoulOutView", "Loading user bitmap");
                loadTexture(mBitmap);
            } else {
                // 创建默认的彩色渐变纹理
                android.util.Log.d("SoulOutView", "Loading default texture");
                loadDefaultTexture();
            }
        }
        ...
        private String loadShaderFromAssets(String filename) {
            ...
            try {
                ...
                reader.close();
                android.util.Log.d("SoulOutView", "Loaded shader: " + filename);
            } catch (IOException e) {
                android.util.Log.e("SoulOutView", "Failed to load shader: " + filename, e);
                e.printStackTrace();
            }
            return sb.toString();
        }
        ...
        private int createProgram(String vertexSource, String fragmentSource) {
            ...
            if (vertexShader == 0) {
                android.util.Log.e("SoulOutView", "Failed to load vertex shader");
                return 0;
            }
            
            int fragmentShader = loadShader(GLES30.GL_FRAGMENT_SHADER, fragmentSource);
            if (fragmentShader == 0) {
                android.util.Log.e("SoulOutView", "Failed to load fragment shader");
                return 0;
            }
            ...
            if (linkStatus[0] == 0) {
                ...
                android.util.Log.e("SoulOutView", "Program link error: " + log);
                GLES30.glDeleteProgram(program);
                return 0;
            }
            
            android.util.Log.d("SoulOutView", "Program created successfully");
            return program;
        }
        ...
        private int loadShader(int type, String shaderSource) {
            ...
            if (compiled[0] == 0) {
                ...
                android.util.Log.e("SoulOutView", "Shader compile error: " + log);
