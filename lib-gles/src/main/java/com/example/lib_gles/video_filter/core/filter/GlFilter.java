...
//    };
  ...
  public GlFilter() {
    ...
    public GlFilter(final Context context,
                    final int vertexShaderSourceResId,
                    final int fragmentShaderSourceResId) {
        this(context,
                GlUtil.raw(context.getResources().openRawResource(vertexShaderSourceResId)),
