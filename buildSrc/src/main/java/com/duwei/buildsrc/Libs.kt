...
object Libs {
    ...
    const val X_Navigation_Fragment_Ktx =
    ...
    const val X_Lifecycle_Extensions =
    ...
    const val Kotlin_Coroutine_Android =
        "org.jetbrains.kotlinx:kotlinx-coroutines-android:${Version.Coroutine_Core}"
    const val Kotlin_Std_Jdk8 = "org.jetbrains.kotlin:kotlin-stdlib-jdk8:${Version.kotlin_version}"
    const val Kotlin_Coroutine_Core =
        "org.jetbrains.kotlinx:kotlinx-coroutines-core:${Version.Coroutine_Core}"
...
//            const val coroutine = "androidx.room:room-coroutines:2.1.0-alpha04"
    ...
    object compose {
        const val activityCompose =
            "androidx.activity:activity-compose:${Version.compose.composeActivity}"
        const val composeComplier =
            "androidx.compose:compose-compiler:${Version.compose.composeVersion}"
        const val composeNavigation =
            "androidx.navigation:navigation-compose:${Version.compose.composeNavigation}"
        const val composeRuntime =
            "androidx.compose.runtime:runtime:${Version.compose.composeVersion}"
        const val constraintLayout =
            "androidx.constraintlayout:constraintlayout-compose:${Version.compose.composeConstraintLayout}"
        const val core = "androidx.compose.ui:ui:${Version.compose.composeVersion}"
        const val foundation =
            "androidx.compose.foundation:foundation:${Version.compose.composeVersion}"
        const val tooling = "androidx.compose.ui:ui-tooling:${Version.compose.composeVersion}"
        const val layout =
            "androidx.compose.foundation:foundation-layout:${Version.compose.composeVersion}"
        const val material = "androidx.compose.material:material:${Version.compose.composeVersion}"
        const val savedInstanceState =
            "androidx.compose.runtime:runtime-saveable:${Version.compose.composeVersion}"
        const val uiTest = "androidx.compose.ui:ui-test-junit4:${Version.compose.composeVersion}"
        const val uiLiveData =
            "androidx.compose.runtime:runtime-livedata:${Version.compose.composeVersion}"
    }
