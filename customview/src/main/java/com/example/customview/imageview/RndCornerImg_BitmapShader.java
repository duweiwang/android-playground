...
public class RndCornerImg_BitmapShader extends ImageView {
    //圆角大小，默认为10
    ...
    public RndCornerImg_BitmapShader(Context context) {
        this(context, null);
    }

    public RndCornerImg_BitmapShader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RndCornerImg_BitmapShader(Context context, AttributeSet attrs, int defStyleAttr) {
