...
public class Camera2Impl extends AbsCamera {
    ...
    public Camera2Impl(CameraStateCallback callback, IPreview preview, Context context) {
        super(callback, preview);
        mCameraManager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
        mPreview.setSurfaceChangeCallback(new IPreview.SurfaceChangeCallback() {
            @Override
