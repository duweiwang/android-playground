...
//
///**
// * @desc:   我其实是个Item的装饰器，只是我实现了一些手势交互接口
// *
// * 通过attachToRecyclerView，将RV传入，设置
// *    mRecyclerView.addOnItemTouchListener(mOnItemTouchListener);监听器，
// *    主要逻辑都在监听器里面实现
// *
// * @auther:duwei
// * @date:2018/9/5
...
//    public static final int ACTION_STATE_SWIPE = 1;//A View is currently being swiped.
//    public static final int ACTION_STATE_DRAG = 2;//A View is currently being dragged.
//
//    /**
...
//         * <p>
//         *  默认值是0.5，他表示：要想swipe一个View，move操作必须至少是RV的一半宽/高
//         */
...
//
//    /**
//     * 对默认callback的包装 which you can construct with drag and swipe
//     * directions and this class will handle the flag callbacks. You should still override onMove
//     * or onSwiped depending on your use case.
//     *
//     * <pre>
