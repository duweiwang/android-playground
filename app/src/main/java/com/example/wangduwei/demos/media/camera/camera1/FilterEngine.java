...
public class FilterEngine {
    ...
    public FilterEngine(int OESTextureId, Context context) {
        ...
        vertexShader = loadShader(GL_VERTEX_SHADER, TextResourceReader.readTextFileFromResource(mContext, R.raw.vertex_camera1glpreview));
        fragmentShader = loadShader(GL_FRAGMENT_SHADER, TextResourceReader.readTextFileFromResource(mContext, R.raw.fragment_camera1glpreview));
