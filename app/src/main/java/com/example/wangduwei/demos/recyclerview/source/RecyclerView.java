//package com.example.wangduwei.demos.recyclerview.source;
//
...
//    public static final int SCROLL_STATE_DRAGGING = 1;//在被拖拽
//    public static final int SCROLL_STATE_SETTLING = 2;//无外部控制情况下，滚到终点的过程
//
...
//
//    /**
//     * 如果RecyclerView的尺寸不受适配器数据影响，那么可以优化性能
...
//
//        // Step 2: Run layout
//        //这里才是真正的布局，需要走LayoutManager里面的onLayoutChildren
//        mState.mInPreLayout = false;
//        mLayout.onLayoutChildren(mRecycler, mState);
//
//        mState.mStructureChanged = false;
...
//         * 结构性改变：插入删除移动
//         * <p>
//         * 这种事件不指定改变类型，会强制所有item不可用，LayoutManager也会全部重新绑定和布局
//         * <p>
...
//
//
//    //分别处理RV，Adapter，Listener的detach通知
...
//    }
//
//    //分别处理RV，Adapter，Listener的attach通知
...
//                removeViewAt(index);//布局remove操作
//                recycler.recycleViewHolderInternal(viewHolder);
//            } else {
//                detachViewAt(index);
//                recycler.scrapView(view);//mAttachedScrap中
...
//        /**
//         * 画一些应用于RV的合适的装饰物
//         * 在item view画之前会画装饰物，也就是会出现在item view 的下面
//         */
...
//
//        /**
//         * 在item view画完之后画，会出现在item view 的上面
//         */
...
//
//        /**
//         * 获取指定view 的一些偏移值. <code>outRect</code> 的每个字段指定了像素值
//         * that the item view should be inset by, 类似于 padding or margin.
//         * 默认实现是：  outRect.set(0, 0, 0, 0);
//         * <p>
//         * 如果不想影响item view 的位置，outRect需要设置全是0
//         * <p>
//         * <p>
...
//        /**
//         * 再被RV或其item view处理之前，静静地观察 和/或 接管发送到recycling view的触摸事件
//         * <p>
...
//
//        //onInterceptTouchEvent返回true时，这里处理事件
//        void onTouchEvent(RecyclerView rv, MotionEvent e);
//
//        //item view不希望RV或其祖先拦截事件
//        void onRequestDisallowInterceptTouchEvent(boolean disallowIntercept);
//    }
//
//    //接口的默认实现，考虑到兼容性，接口可能会变
...
//
//        static final int FLAG_BOUND = 1 << 0;//被绑定
//
//        /**
