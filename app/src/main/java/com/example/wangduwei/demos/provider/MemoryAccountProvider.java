...
/**
 * @author 杜伟
 * @date 2022/4/27 11:03 AM
 */
public class MemoryAccountProvider extends ContentProvider {

    public static final String TAG = "m039";

    public static final String AUTHORITY = "com.m039.example.provider";
    ...
    public static final class Words {
        public static class Account {
            public static final String CONTENT_TYPE = "vnd.android.cursor.dir" + "/" + AUTHORITY + "." + AccountColumns.ACCOUNT;
            public static final String ENTRY_CONTENT_TYPE = "vnd.android.cursor.item" + "/" + AUTHORITY + "." + AccountColumns.ACCOUNT;
            public static final String DEFAULT_SORT_ORDER = AccountColumns.NAME;

            public static final Uri CONTENT_URI;

            static {
                CONTENT_URI = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + AUTHORITY + "/" + AccountColumns.ACCOUNT);
            }
    ...
    static {
        ...
        sUriMatcher.addURI(AUTHORITY, Words.AccountColumns.ACCOUNT + "/#/" + Words.AccountColumns.NAME, MATCH_ACCOUNT_NAME);
    ...
    public Cursor query (Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        switch (sUriMatcher.match(uri)) {
            ...
            default: throw new IllegalArgumentException("Invalide URI");
        }
    }
