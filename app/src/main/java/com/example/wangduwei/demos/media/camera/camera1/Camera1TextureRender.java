 ...
 * @date:2019/4/1
 */
public class Camera1TextureRender implements SurfaceTexture.OnFrameAvailableListener {
    ...
    public void init(TextureView textureView, int textureId, Context context) {
        mContext = context;
    ...
    private void initEGL() {
        ...
        //构造需要的配置列表
        int[] attributes = {EGL10.EGL_RED_SIZE, 8,
